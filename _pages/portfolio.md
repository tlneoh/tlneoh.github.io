...
- <div style="text-align: justify;">Built a full-stack website for a small dental clinic to manage appointments.</div>
...
- <div style="text-align: justify;"><a href="https://github.com/tneo0002/AlcoholConsumptionShinyDashboard" target="_blank">Take a look</a> or follow the <a href="/files/DockerisedRShinyAppInstructions.pdf" target="_blank">instructions</a> to run the container locally (access token available on resume or on request).</div>
  <figure style="border: 0.5px solid black; text-align: left;">
